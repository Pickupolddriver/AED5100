...
//************************input the data in to the system**************************************//
        ...
        MasterSchedule masterschedule = ta1.getMasterschedule();
        masterschedule.printEachFlightRevenue();
      
     
       
     //Print per Airliner & all the flight of All airliner;  
       AllAirliner allairliner = ta1.getAllairliner();
        allairliner.printAllAirlinerRevenue();
     
     int ReveneuOfAllAirliner=allairliner.getSumofAllairliner();
     System.out.println("All Airliners' total revenue is  "+ReveneuOfAllAirliner);
     
        //Person p1 = ta1.getCustomerdirectory().getCustomerDirectory().get(0);
