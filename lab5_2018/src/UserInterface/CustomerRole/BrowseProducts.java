...
public class BrowseProducts extends javax.swing.JPanel {
    ...
    public void refreshProductTable(String name) {
        DefaultTableModel model = (DefaultTableModel) productTable.getModel();
        model.setRowCount(0);
    ...
    private void suppComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_suppComboBox1ActionPerformed
        ...
        populateTable();
        //when the comboBoxChanged we need to refresh the table;
    ...
    private void addtoCartButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addtoCartButton6ActionPerformed
        ...
        try {
            ...
            if (salesPrice <= selectedProduct.getPrice()) {
                JOptionPane.showMessageDialog(null, " SalsePrice cannot be less than actual");
                return;
            }
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            if (newQty > (currentAvail + oldQty)) {
                JOptionPane.showMessageDialog(null, "Qty more than Avail");
                return;
            } else {
                if (newQty <= 0) {
                    JOptionPane.showMessageDialog(null, "Qty should be more than 0");
                    return;
                }
