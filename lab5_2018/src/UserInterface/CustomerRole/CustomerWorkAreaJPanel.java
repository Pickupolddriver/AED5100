...
public class CustomerWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public CustomerWorkAreaJPanel(JPanel upc, SupplierDirectory sd, MasterOrderCatalog mc) {
        initComponents();
        this.userProcessContainer = upc;
        this.supplierDirectory = sd;
        this.masterOrderCatalog = mc;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        BrowseProducts ms = new BrowseProducts(userProcessContainer, supplierDirectory,masterOrderCatalog);
        userProcessContainer.add("BrowseProducts", ms);
