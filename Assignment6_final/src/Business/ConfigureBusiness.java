...
public class ConfigureBusiness {
    ...
    public void loadAdmin(){
        final String fileName = "adminCSV.csv";
        try (BufferedReader inline = new BufferedReader(new FileReader(fileName));) {
            ...
            while ((inputline = inline.readLine()) != null) {
                ...
                Double balance = Double.valueOf(fields[6]);
                
                Admin a = business.getAdmind().addAdmin();

                a.setFirstName(fname);
                a.setLastName(lname);
                a.setGender(gender);
                a.setEmail(email);
                a.getBank().setBalance(balance);
                Account account = business.getAd().addAccount();
                account.setUserName(username);
                account.setPassword(password);
                account.setRole(Account.ADMIN);
                account.setPerson(a);
                account.setStatus("Always active");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void loadBuyer() {
        ...
        try (BufferedReader inline = new BufferedReader(new FileReader(fileName));) {
            ...
            while ((inputline = inline.readLine()) != null) {
                ...
                Double balance = Double.valueOf(fields[21]);
    ...
    public void loadSeller() {
        ...
        try (BufferedReader inline = new BufferedReader(new FileReader(fileName));) {
            ...
            while ((inputline = inline.readLine()) != null) {
                ...
                Double balance = Double.valueOf(fields[17]);
