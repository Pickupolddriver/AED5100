...
public class checkoutPanel extends javax.swing.JPanel {
    ...
    private void btnPlaceOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlaceOrderActionPerformed
        ...
        /**
         * ******March 19 New Version in this version we need to initialize a
         * WorkRequest and put the order into the WorkRequest and  *************
         */
        //the OrderList in Buyer is a temperary List
        for (Wine w1 : buyer.getCart()) {
            //从购物车里面读取Wine--the number in the cart must valid--I have made some validation before

            WorkRequest wr = business.getWq().addWorkQuest();
            Order o1 = new Order();
            //did not add into the buyer's orderlist
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            String str = sdf.format(new Date());
            wr.setRequestDate(str);
            wr.setOrder(o1);
            wr.setStatus("Pending");
            //Wr need to set the resolve date;
            //create a new order
