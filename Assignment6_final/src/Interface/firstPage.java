...
import Business.*;
import Interface.Admin.adminStartPanel;
        ...
        for (Account a : business.getAd().getAccountList()) {
            if (a.getUserName().equals(userName) && a.getPassword().equals(password)) {
                ...
                if (a.getRole().equals(Account.BUYER)) {
                    ...
                    flag = true;
                    break;
                } else if (a.getRole().equals(Account.ADMIN)){
                    adminStartPanel asp = new adminStartPanel(processPanel, (Admin)a.getPerson(), business);
                    processPanel.add("adminStartPanel", asp);
                    CardLayout card = (CardLayout)processPanel.getLayout();
                    card.next(processPanel);
                    flag = true;
                }
